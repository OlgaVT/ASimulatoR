...
functionality of this package check the following example. The example is limited to the chromosome 21 for the runtime purpose. For even more flexibility refer to the section "The main function: `simulate_alternative_splicing`":
